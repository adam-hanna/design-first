...
exports.genMiddleware = (middlewareDir, design) => __awaiter(this, void 0, void 0, function* () {
    if (yield !fs_extra_1.existsSync(middlewareDir)) {
        throw new Error("could not find directory './context'. Did you '$ design-first init [name] && cd [name] && design-first gen <file>'?");
    }
    for (const service of design.services) {
        ...
        for (const action of service.actions) {
            ...
            yield fs_extra_1.writeFileSync(actionFile, exports.genRouteMiddleware(actionPath, service, action));
        }
    }
});
exports.genRouteMiddleware = (actionPath, service, action) => {
