...
exports.genAuthorization = (authorizationDir, design) => __awaiter(this, void 0, void 0, function* () {
    ...
    for (const service of design.services) {
        ...
        for (const action of service.actions) {
            ...
            yield fs_extra_1.writeFileSync(actionFile, exports.genRouteAuthorization(actionPath, service, action));
        }
    }
});
exports.genRouteAuthorization = (actionPath, service, action) => {
